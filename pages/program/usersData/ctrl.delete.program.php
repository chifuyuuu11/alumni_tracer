...
$select_user = mysqli_query($conn, "SELECT * FROM tbl_program WHERE program_id = '$program_id'");
$row = mysqli_fetch_array($select_user);
$program = $row['program'];
$delete_program = mysqli_query($conn, "DELETE FROM tbl_program WHERE program_id = '$program_id'");
