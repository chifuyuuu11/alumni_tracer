                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form action="usersData/ctrl.edit.student.info.php?user_id=<?php echo $user_id; ?>"
                                    ...
                                    <?php
                                    $info = mysqli_query($conn, "SELECT *, CONCAT(firstname, ' ', middlename, ' ', lastname) AS fullname FROM tbl_student
                                    LEFT JOIN tbl_users ON tbl_users.user_id = tbl_student.user_id
                                    LEFT JOIN tbl_roles ON tbl_roles.role_id = tbl_users.role_id
                                    WHERE tbl_student.user_id = '$user_id'");
                                    while ($row = mysqli_fetch_array($info)) {
                                        ...
                                        <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="student" name="student"
                                                    value="<?php echo $row['student'] ?>" placeholder="Student No.">
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="batch" name="batch"
                                                    value="<?php echo $row['firstname'] ?>" placeholder="Batch">
                                            </div>
                                        </div>
                                </div>
                                <!-- /.card-body -->
