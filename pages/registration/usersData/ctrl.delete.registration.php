...
$insert_log = mysqli_query($conn, "INSERT INTO tbl_logs (username, role, action, sp_action, link, updated_at) VALUES ('$_SESSION[username]', '$_SESSION[user_role]', 'Delete Registration', '$fullname', 'ctrl.delete.registration.php', 'DEFAULT CURRENT_TIMESTAMP')");
